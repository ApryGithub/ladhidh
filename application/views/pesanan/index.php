						...
						<div class="row">
							<div class="card" style="width: 100%">
						      ...
						      <div class="card-body">
						        <div class="row">
						        	<div class="col-lg-2">
						        		<img src="<?= base_url('assets/img/menu/'.$p['kategori'].'/') . $p['image']; ?>" class="card-img">
						        	</div>
		                      ...
		                      <span class="input-group-btn">
		                          <a href="<?= base_url('pesanan/tambah/') . $p['pesanan_id']; ?>" class="btn-qty">
						        	...
						        	<div class="col-lg-1 d-flex align-items-center justify-content-end">
						        		<a href="<?= base_url('pesanan/delete/') . $p['pesanan_id']; ?>" class="btn-delete"><i class="fa fa-lg fa-times"></i></a>
						        	</div>
						        </div>
